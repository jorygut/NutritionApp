...
const AddDetails: React.FC = () => {
  ...
  const CheckIngredients = async (ingredients) => {
    try {
      ...
      const response = await axios.post('http://127.0.0.1:5000/api/checkIngredients', data, config);
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.foodItem}>
        ...
        <Text style={styles.foodDetails}>Calories: {(food.calories * servingMultiplier).toFixed(1)}</Text>
        <Text style={styles.foodDetails}>Protein: {(food.protein * servingMultiplier).toFixed(1)}g</Text>
        <Text style={styles.foodDetails}>Saturated Fat: {(food.saturatedFat * servingMultiplier).toFixed(1)}g</Text>
        <Text style={styles.foodDetails}>Trans Fats: {(food.transFat * servingMultiplier).toFixed(1)}g</Text>
        <Text style={styles.foodDetails}>Fat: {(food.fat * servingMultiplier).toFixed(1)}g</Text>
        <Text style={styles.foodDetails}>Carbs: {(food.carbohydrates * servingMultiplier).toFixed(1)}g</Text>
        <Text style={styles.foodDetails}>Fiber: {(food.fiber * servingMultiplier).toFixed(1)}g</Text>
        <Text style={styles.foodDetails}>Sugar: {(food.sugars * servingMultiplier).toFixed(1)}g</Text>
        <Text style={styles.foodDetails}>Sodium: {(food.sodium * servingMultiplier).toFixed(1)}mg</Text>
        <Text style={styles.foodDetails}>Cholesterol: {(food.cholesterol * servingMultiplier).toFixed(1)}mg</Text>
        <Text style={styles.foodDetails}>Iron: {(food.iron * servingMultiplier).toFixed(1)}mg</Text>
        <Text style={styles.foodDetails}>Calcium: {(food.calcium * servingMultiplier).toFixed(1)}mg</Text>
        <Button
