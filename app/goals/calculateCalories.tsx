...
const Measurements: React.FC = () => {
    ...
    const FetchWeight = async () => {
        try {
            ...
            const response = await axios.get('http://127.0.0.1:5000/api/getCurrentWeight', config);
    ...
    const FetchUserData = async () =>{
        try{
            ...
            const response = await axios.get('http://127.0.0.1:5000/api/getStats', config)
            if (response.status === 200){
    ...
    const CalculateCalorieNeeds = async () => {
        try {
            ...
            const response = await axios.post('http://127.0.0.1:5000/api/calculateCalorieNeeds', data, config);
    ...
    const SaveGoals = async () =>{
        try{
            ...
            const response = await axios.post('http://127.0.0.1:5000/api/saveCalculatedMacros', data, config)
        }
        catch(error){
            console.log(error);
        }
