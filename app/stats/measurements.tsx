...
const Measurements: React.FC = () => {
    ...
    const FetchLogs = async () => {
        try {
            ...
            const response = await axios.get('http://127.0.0.1:5000/api/bodyMeasurements', config);
    ...
    const FetchGoals = async () => {
        try {
            ...
            const response = await axios.get('http://127.0.0.1:5000/api/fetchNutrientGoals', config);
            if (response.status === 200) {
                console.log(response.data);
